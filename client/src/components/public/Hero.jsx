      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center justify-center text-center">
        ...
        >
          ...
          <div className="relative flex justify-center items-end w-full">
            ...
            <div className="absolute top-6 left-4 sm:left-8 flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/90 backdrop-blur-md text-xs font-mono text-cyan-400 border border-cyan-500/40 shadow-lg">
              <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
              <span>Full Stack Developer</span>
            </div>

            {/* Education Badge */}
            <div className="absolute top-6 right-4 sm:right-8 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-900/90 backdrop-blur-md text-xs font-mono text-indigo-300 border border-indigo-500/40 shadow-lg">
